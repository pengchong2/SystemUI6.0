...
public interface IStatusBarPlugin {
     ...
     * Customize VoLTEIcon.
     *
     * @param icon the VoLTE icon.
     */
    void customizeVoLTEIconId(IconIdWrapper icon);
    ...
    /**
     * Customize the mobile state.
     *
     * @param serviceState The service state
     * @param state The original state
     * @return The customized state
     */
    int customizeMobileState(ServiceState serviceState, int state);
