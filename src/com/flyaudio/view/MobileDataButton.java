...
public class MobileDataButton extends PowerButton {
	...
	if (!isAirPlaneOn(context)) {
       ...
       //         false);
		setUI("flyaudio_systemui_mobiledata_bg_u","flyaudio_data_tv","flyaudio_systemui_button_textcolor_u",false);
	...
	if (mMobileDataEnabled) {
          ...
          //  setUI("systemui_stat_data_on", "mobiledata_button", "power_button_text_color",
           //         true);
		setUI("flyaudio_systemui_mobiledata_bg_d","flyaudio_data_tv","flyaudio_systemui_button_textcolor_d",false);
