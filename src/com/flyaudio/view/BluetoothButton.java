...
public class BluetoothButton extends PowerButton {
    ...
    protected void updateState(Context context) {
       ...
       //     setUI("systemui_bluetooth_on", "bluetooth_button", "power_button_text_color",true);
            setUI("flyaudio_systemui_bluetooth_bg_d", "flyaudio_bluetooth_tv", "flyaudio_systemui_button_textcolor_d",false);
            mState = STATE_ENABLED;
        } else {
          //  setUI("systemui_bluetooth_off", "bluetooth_button",
          //         "power_button_text_color_d", false);
            setUI("flyaudio_systemui_bluetooth_bg_u", "flyaudio_bluetooth_tv", "flyaudio_systemui_button_textcolor_u",false);
        ...
        if (FLY_BLUETOOTH_SWITCH.equals(action)) {
            ...
            switch (intent.getIntExtra("btSwitch", 0)) {
                ...
                case 1:
                  ...
                  //          true);
                    setUI("flyaudio_systemui_bluetooth_bg_d", "flyaudio_bluetooth_tv", "flyaudio_systemui_button_textcolor_d",true);
                    mState = STATE_ENABLED;
                    isBTOpen = true;
                    break;
                default:
    ...
    protected boolean handleLongClick(Context context) {
        Log.d(TAG,"handleLongClick bt_page");
