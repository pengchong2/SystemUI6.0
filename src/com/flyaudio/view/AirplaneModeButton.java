...
public class AirplaneModeButton extends PowerButton {
	...
	if (getDataState(context)) {
		...
		setUI("flyaudio_systemui_airplane_bg_d","flyaudio_airplane_tv","flyaudio_systemui_button_textcolor_d",false);
            mState = STATE_ENABLED;         
        } else {
        	//setUI("systemui_airplane_mode_off","airplane_mode_button","power_button_text_color_d",false);
		setUI("flyaudio_systemui_airplane_bg_u","flyaudio_airplane_tv","flyaudio_systemui_button_textcolor_u",false);
