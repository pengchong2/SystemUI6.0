...
public class WifiButton extends PowerButton {
        ...
        protected void requestStateChange(Context context,
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... args) {
                    ...
                    Flog.d("WifiButton", "setWifiEnabled   ==   " + desiredState);
    ...
    protected void updateState(Context context) {
        Flog.d("wibt", "updateState");
        mState = sWifiState.getTriState(context);
        switch (mState) {
            case STATE_DISABLED:
              //  setUI("systemui_stat_wifi_off", "wifi_button", "power_button_text_color_d", false);
                setUI("flyaudio_systemui_wifi_bg_u", "flyaudio_wifi_tv", "flyaudio_systemui_button_textcolor_u", false);
                break;
            case STATE_ENABLED:
              //  setUI("systemui_stat_wifi_on", "wifi_button", "power_button_text_color", true);
                setUI("flyaudio_systemui_wifi_bg_d", "flyaudio_wifi_tv", "flyaudio_systemui_button_textcolor_d", false);
                break;
