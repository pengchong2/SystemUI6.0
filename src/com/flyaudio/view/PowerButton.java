...
public abstract class PowerButton implements OnTouchListener {
    ...
    protected void onReceive(Context context, Intent intent) {
        if (intent.getAction().equals("action.flyaudio.colortheme")) {
            Flog.d(TAG, "PowerButton 接收到color theme广播");
...
//            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(66,66);
//            lp.rightMargin = 60;
//            lp.bottomMargin = 16;
//            mOutLayout.setLayoutParams(lp);
           /* mIconView = (ImageView) mView.findViewById(
                    SkinResource.getSkinResourceId("power_widget_button_image", "id"));*/
            /*mIconTagView = (ImageView) mView.findViewById(
                            SkinResource.getSkinResourceId("power_widget_button_tag_image", "id"));*/
    ...
    public boolean onTouch(View view, MotionEvent event) {
        boolean change = SkinResource.getSkinStringByName("isColorSkin").equals("isColorSkin");
        String colorFromPro = "-65536";
        if (change) {
            colorFromPro = SystemProperties.get("persist.fly.colortheme", "-65536");
        }
        ...
        if (view.getId() == 5) {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                if (change) {
                    text.setTextColor(Integer.parseInt(colorFromPro));
                } else {
                    text.setTextColor(
                            SkinResource.getSkinColorByName("power_button_text_color"));
                }
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                linearLayout
                        .setBackgroundDrawable(SkinResource.getSkinDrawableByName("flyaudio_systemui_audio_bg_d"));
                text.setTextColor(SkinResource.getSkinColorByName("flyaudio_systemui_button_textcolor_d"));
            } else if (event.getAction() == MotionEvent.ACTION_UP
                    ||event.getAction() == MotionEvent.ACTION_CANCEL) {
                linearLayout
                        .setBackgroundDrawable(SkinResource.getSkinDrawableByName("flyaudio_systemui_audio_bg_u"));
                text.setTextColor(SkinResource.getSkinColorByName("flyaudio_systemui_button_textcolor_u"));
            }
        }
