...
public class KeyguardViewMediator extends SystemUI {
    ...
    private boolean mFlyaudioNotic = false; //flyaudio+
    ...
    private void doKeyguardLocked(Bundle options) {
        Log.d(TAG, "doKeyguardLocked: ");
         /*hide keyguard */
        boolean is_show_lockscreen_on = SkinResource.getSkinBooleanFromSkin("no_show_lockscreen");
        Log.d(TAG, "doKeyguardLocked: >"+is_show_lockscreen_on);
        if (is_show_lockscreen_on) {
            Log.d(TAG, "flyaudio-doKeyguardLocked: 屏蔽锁屏页");
