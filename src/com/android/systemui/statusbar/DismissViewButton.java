...
public class DismissViewButton extends Button {
    ...
    public DismissViewButton(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mAnimatedDismissDrawable = (AnimatedVectorDrawable)
                SkinResource.getSkinDrawableByName("flyaudio_dismiss_all_shape_animation").mutate();
        ...
        mStaticDismissDrawable = SkinResource.getSkinDrawableByName("flyaudio_dismiss_all_shape");
