...
public class CallbackHandler extends Handler implements EmergencyListener, SignalCallback {
    ...
    public void setMobileDataIndicators(final IconState statusIcon, final IconState qsIcon,
            final int statusType, final int networkIcon, final int qsType,final boolean activityIn,
            final boolean activityOut,
            /// M: Add for CT6M. add activity icon @{
            final int dataActivity,
            final int primarySimIcon,
            /// @}
            ...
            public void run() {
                for (SignalCallback signalCluster : mSignalCallbacks) {
                    ...
                    signalCluster.setMobileDataIndicators(statusIcon, qsIcon, statusType,
                            networkIcon, qsType, activityIn, activityOut, 
                            /// M: Add for CT6M. add activity icon @{
                            dataActivity,
                            primarySimIcon,
                            /// @}
    ...
    /// M: Add for [SIM Indicator] interface
