...
public abstract class ActivatableNotificationView extends ExpandableOutlineView {
    ...
    public ActivatableNotificationView(Context context, AttributeSet attrs) {
        ...
        mLegacyColor =SkinResource.getSkinColorByName("notification_legacy_background_color");
        mNormalColor = SkinResource.getSkinColorByName("notification_material_background_color");
        mLowPriorityColor =SkinResource.getSkinColorByName("notification_material_background_low_priority_color");
        mTintedRippleColor =SkinResource.getSkinColorByName("notification_ripple_tinted_color");
        mLowPriorityRippleColor =SkinResource.getSkinColorByName("notification_ripple_color_low_priority");
        mNormalRippleColor =SkinResource.getSkinColorByName("notification_ripple_untinted_color");
    ...
    protected void onFinishInflate() {
        ...
        mBackgroundNormal.setCustomBackground(SkinResource.getSkinDrawableByName("notification_material_bg"));
        mBackgroundDimmed.setCustomBackground(SkinResource.getSkinDrawableByName("notification_material_bg_dim"));
        updateBackground();
