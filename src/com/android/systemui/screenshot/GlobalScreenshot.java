...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void,
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
        ...
        mScreenshotDir =
                FlyAudioProcess.getInstance().FlyScreenshotDir(context, SCREENSHOTS_DIR_NAME);
...
class GlobalScreenshot {
    ...
    void takeScreenshot(Runnable finisher, boolean statusBarVisible, boolean navBarVisible) {
        ...
        if (FlyAudioProcess.getInstance().FlyScreenshotDir(mContext, "Screenshots")==null) {
            notifyScreenshotError(mContext, mNotificationManager);
            finisher.run();
            Toast failedScreenshot = Toast.makeText(mContext,
                    SkinResource.getSkinStringByName("failedScreenshot"), Toast.LENGTH_LONG);
            failedScreenshot.getWindowParams().type = WindowManager.LayoutParams.TYPE_STATUS_BAR_PANEL;
            failedScreenshot.getWindowParams().privateFlags |= WindowManager.LayoutParams.PRIVATE_FLAG_SHOW_FOR_ALL_USERS;
            failedScreenshot.getWindowParams().flags |= WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED;
            failedScreenshot.show();
            return;
        }
